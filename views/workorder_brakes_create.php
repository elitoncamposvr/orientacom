<div class="breadcrumb">
    <span class="breadcrumb-title">Ordem de Serviço nº <?php echo $workorder_id; ?><i class="fa-solid fa-chevron-right px-2 fa-xs"></i> Verificação de Itens <i class="fa-solid fa-chevron-right px-2 fa-xs"></i> Freios</span>
...
<form class="w-full py-2.5 flex-col" action="<?php echo BASE_URL; ?>workorder/steeringsystem_store/<?php echo $workorder_id; ?>" method="post">
    <div class="input-line rounded-md bg-slate-200 p-2 flex-col mb-2">
        ...
        <div class="input-line">
            ...
            <div class="w-4/12">
                <input type="text" name="hose_flexible_obs" id="hose_flexible_obs" class="w-full">
            </div>
        </div>
        ...
        <div class="input-line">
            ...
            <div class="w-4/12">
                <input type="text" name="brake_pads_obs" id="brake_pads_obs" class="w-full">
            </div>
        </div>
        ...
        <div class="input-line">
            ...
            <div class="w-4/12">
                <input type="text" name="brake_discs_obs" id="brake_discs_obs" class="w-full">
            </div>
        </div>
        ...
        <div class="input-line">
            ...
            <div class="w-4/12">
                <input type="text" name="brake_calipers_obs" id="brake_calipers_obs" class="w-full">
            </div>
        </div>
        ...
        <div class="input-line">
            ...
            <div class="w-4/12">
                <input type="text" name="cover_plates_obs" id="cover_plates_obs" class="w-full">
            </div>
        </div>
        ...
        <div class="input-line">
            ...
            <div class="w-4/12">
                <input type="text" name="pedal_condition_obs" id="pedal_condition_obs" class="w-full">
            </div>
        </div>
